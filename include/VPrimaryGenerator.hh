...
class VPrimaryGenerator{
    public:
        ...
        virtual void GeneratePrimaryVertex(G4Event *){
	       G4cout<<"VPrimaryGenerator::GeneratePrimaryVertex: Not implemented!"<<G4endl;
        }

        virtual G4String GetGeneratorName(void) {return fGeneratorName;}
        virtual void SetGeneratorName(G4String name) {fGeneratorName = name;}

        virtual void PrintGeneratorInfo(void){
            G4cout<<"VPrimaryGenerator::PrintGeneratorInfo - Not implemented!"<<G4endl;
        }
